-- ============================================================
-- HOW TO USE:
--   psql -U postgres -d mydb -f privacy_budget.sql
--   psql -U postgres -d mydb -f sample_data.sql
--   psql -U postgres -d mydb -f demo_queries.sql
-- ============================================================
...
-- ============================================================
-- TABLE: budget_alerts
-- Warnings at 75%, 90%, and 100% budget consumption.
-- ============================================================
CREATE TABLE IF NOT EXISTS diffpriv.budget_alerts (
    alert_id     SERIAL PRIMARY KEY,
    analyst_id   INTEGER NOT NULL REFERENCES diffpriv.analysts(analyst_id),
    alert_type   VARCHAR(30) NOT NULL, -- 'WARNING_75', 'WARNING_90', 'EXHAUSTED'
...
-- ============================================================
-- FUNCTION: register_analyst
-- Adds a new analyst with a specified total epsilon budget.
-- Usage: SELECT diffpriv.register_analyst('alice', 1.0);
-- ============================================================
...
-- Usage: SELECT diffpriv.get_remaining_budget(1);
-- ============================================================
...
-- Usage: SELECT diffpriv.check_budget(1, 0.2);
-- ============================================================
...
-- ============================================================
-- INTERNAL: _raise_budget_alert
-- Inserts threshold warnings into budget_alerts.
-- ============================================================
...
-- ============================================================
-- FUNCTION: spend_budget   <-- CORE FUNCTION
-- Atomically deducts epsilon from analyst budget.
-- Logs the query, enforces limits, fires alerts.
-- Returns: log_id on success.
-- Raises:  EXCEPTION if budget would be exceeded.
--
-- Usage:
--   SELECT diffpriv.spend_budget(
--       1,                          -- analyst_id
--       'SELECT COUNT(*) FROM ...',  -- query text
--       0.1,                        -- epsilon requested
--       'laplace',                  -- mechanism
--       1.0                         -- global sensitivity
--   );
-- ============================================================
...
BEGIN
    ...
    -- Fire threshold alerts if needed
...
-- ============================================================
-- FUNCTION: reset_budget  (admin)
-- Resets analyst budget_used to 0. Useful for new time windows.
-- ============================================================
...
-- ============================================================
-- VIEW: budget_status
-- Overview of all analysts and their budget consumption.
-- ============================================================
...
-- ============================================================
-- VIEW: query_history
-- Full query log joined with analyst names.
-- ============================================================
